...
export default class Agenda extends Component<AgendaProps, State> {
    ...
    static propTypes: {
        ...
        renderHeader: PropTypes.Requireable<any>; /** When `true` and `hideKnob` prop is `false`, the knob will always be visible and the user will be able to drag the knob up and close the calendar. Default = false */
