...
const CalendarsScreen = () => {
    ...
    const renderCalendarWithSelectableDate = () => {
        ...
        <Calendar testID={testIDs.calendars.FIRST} enableSwipeMonths current={INITIAL_DATE} style={styles.calendar} onDayPress={onDayPress} markedDates={{
                [selected]: {
                    selected: true,
    ...
    const renderSwitch = () => {
        ...
        <Switch trackColor={{ false: '#d9e1e8', true: '#00BBF2' }} onValueChange={toggleSwitch} value={showMarkedDatesExamples}/>
