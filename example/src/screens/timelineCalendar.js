...
export default class TimelineCalendarScreen extends Component {
    state = {
        ...
        events: EVENTS,
        eventsByDate: _.groupBy(EVENTS, e => CalendarUtils.getCalendarDateString(e.start))
    };
    marked = {
    ...
    render() {
        ...
        return (<CalendarProvider date={currentDate} onDateChanged={this.onDateChanged} onMonthChange={this.onMonthChange} showTodayButton disabledOpacity={0.6}>
        <ExpandableCalendar firstDay={1} leftArrowImageSource={require('../img/previous.png')} rightArrowImageSource={require('../img/next.png')} markedDates={this.marked}/>
